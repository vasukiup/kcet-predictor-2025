...
class Checker {
     ...
     *     failure
     */
    addFailure(start, end, failureText, source, allowlist, fixes) {
        ...
        const failure = new failure_1.Failure(this.currentSourceFile, start, end, failureText, this.currentCode, source, fixes !== null && fixes !== void 0 ? fixes : []);
    ...
    addFailureAtNode(node, failureText, source, allowlist, fixes) {
        // node.getStart() takes a sourceFile as argument whereas node.getEnd()
        // doesn't need it.
        this.addFailure(node.getStart(this.currentSourceFile), node.getEnd(), failureText, source, allowlist, fixes);
    }
...
exports.Checker = Checker;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/e0b7a2bcf575cfba10528c4e7c10bd3ce2d7769a/node_modules/tsec/lib/common/third_party/tsetse/checker.js.map