...
exports.logASTWalkError = exports.isAllowlistedNamedDeclaration = exports.isPartOfTypeDeclaration = exports.dealias = exports.isInStockLibraries = exports.shouldExamineNode = exports.findInChildren = exports.parents = exports.debugLog = exports.setDebug = void 0;
...
function isOnRHSOfInstanceOf(n) {
...
function shouldExamineNode(n) {
    return !((n.parent && ts.isTypeNode(n.parent)) || isOnRHSOfInstanceOf(n) ||
...
exports.logASTWalkError = logASTWalkError;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/e0b7a2bcf575cfba10528c4e7c10bd3ce2d7769a/node_modules/tsec/lib/common/third_party/tsetse/util/ast_tools.js.map