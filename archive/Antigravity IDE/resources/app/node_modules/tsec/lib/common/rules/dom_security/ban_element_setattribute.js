...
class BanSetAttributeRule extends rule_1.AbstractRule {
    ...
    isAllowedAttribute(typeChecker, attr) {
        ...
        if (this.looseMatch) {
            ...
            return !attrType.isStringLiteral() || !(0, is_literal_1.isLiteral)(typeChecker, attr) ||
                !this.isSecuritySensitiveAttrName(attrType.value.toLowerCase());
        }
    }
...
class Rule extends BanSetAttributeRule {
    constructor(configuration = {}) {
        ...
        this.isSecuritySensitiveAttrName = (attr) => (attr.startsWith('on') && attr !== 'on') ||
            exports.TT_RELATED_ATTRIBUTES.has(attr);
        this.looseMatch = true;
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-element-setattribute';//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/e0b7a2bcf575cfba10528c4e7c10bd3ce2d7769a/node_modules/tsec/lib/common/rules/dom_security/ban_element_setattribute.js.map