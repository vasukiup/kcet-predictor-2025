    ...
    visitMetadataNode(currentNode) {
        ...
        if (type.isStringLiteral()) {
            ...
            if (nodeName === 'owner' || nodeName === 'comment' || nodeName === 'expiration') {
                this.properties.push(new events_1.Metadata(nodeName, this.resolved_property[nodeName]).simpleObject());
            }
        }
    }
...
class TsParser {
    ...
    constructor(sourceDir, excludedDirs, applyEndpoints, lowerCaseEvents) {
        ...
        try {
            const retrieved_paths = cp.execFileSync(ripgrep_1.rgPath, ripgrepArgs, { encoding: 'ascii' });
    ...
    parseFiles() {
        ...
        publicLogUse.forEach((pl) => {
            try {
                ...
                const created_event = new events_1.Event(event_name);
...
exports.TsParser = TsParser;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/e0b7a2bcf575cfba10528c4e7c10bd3ce2d7769a/node_modules/@vscode/telemetry-extractor/out/lib/ts-parser.js.map