...
function populateProperties(properties, target, applyEndpoints = false) {
    for (const propertyName in properties) {
        ...
        if (propertyName === keywords.include) {
            ...
            target.properties.push(new events_1.Metadata(propertyName, currentProperty));
        }
        else {
...
exports.makeExclusionsRelativeToSource = makeExclusionsRelativeToSource;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/e0b7a2bcf575cfba10528c4e7c10bd3ce2d7769a/node_modules/@vscode/telemetry-extractor/out/lib/operations.js.map