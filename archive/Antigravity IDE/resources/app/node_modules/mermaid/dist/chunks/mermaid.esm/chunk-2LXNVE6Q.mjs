...
function htmlRemove() {
  this.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML("") : "";
}
__name(htmlRemove, "htmlRemove");
function htmlConstant(value) {
  return function() {
    this.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML(value) : value;
  };
}
...
function htmlFunction(value) {
  return function() {
    var v = value.apply(this, arguments);
    const htmlValue = v == null ? "" : v;
    this.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML(htmlValue) : htmlValue;
  };
}
