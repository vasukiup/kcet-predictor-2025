...
var render = /* @__PURE__ */ __name(async function(id28, text, svgContainingElement) {
  ...
  if (svgContainingElement !== void 0) {
    if (svgContainingElement) {
      svgContainingElement.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML("") : "";
    }
    if (isSandboxed) {
  ...
  style1.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML(rules) : rules;
...
function initialize(userOptions = {}) {
  ...
  if (userOptions.trustedPolicy) {
    globalThis._mermaidTrustedPolicy = userOptions.trustedPolicy
  }
...
var runThrowsErrors = /* @__PURE__ */ __name(async function({ postRenderCallback, querySelector, nodes } = {
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    try {
      ...
      element.innerHTML = globalThis._mermaidTrustedPolicy ? globalThis._mermaidTrustedPolicy.createHTML(svg) : svg;
