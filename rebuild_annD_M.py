...
ann_d = [
    college(1, "A J Institute Of Engineering And Technology, Mangalore",
        ...
        c_row("COMPUTER SCIENCE AND ENGG (ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING)", 120, 48, 3, 1,  3,  41, 44,  36,  36, 6),
        c_row("COMPUTER SCIENCE AND ENGG (INTERNET OF THINGS & CYBER SECURITY INCLUDING BLOCK CHAIN TECH)", 60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                   150, 60, 3, 1,  4,  52, 56,  45,  45, 7),
        c_row("ELECTRONICS ENGINEERING(VLSI DESIGN & TECHNOLOGY)",                  60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
    ...
    college(2, "Anjuman Institute of Technology & Management, Bhatkal",
        ...
        c_row("COMPUTER SCIENCE AND ENGG (ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING)", 120, 48, 2, 1,  3,  42, 45,  36,  36, 6),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                   120, 48, 2, 1,  3,  42, 45,  36,  36, 6),
        c_row("COMPUTER SCIENCE AND ENGINEERING (DATA SCIENCE)",                     60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        ...
        c_row("MECHANICAL ENGINEERING",                                              30, 12, 1, 0,  1,  10, 11,   9,   9, 2),
        c_row("ROBOTICS AND ARTIFICIAL INTELLIGENCE",                                60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
    ]),
    college(3, "Bahubali College of Engineering, Shravanabelagola, Hassan",
        "SHRAVANABELAGOLA, HASSAN", "Hassan", [
        c_row("ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING",                         60, 24, 1, 1,  2,  20, 22,  18,  18, 3),
        c_row("CIVIL ENGINEERING",                                                   30, 12, 1, 0,  1,  10, 11,   9,   9, 1),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                    60, 24, 1, 1,  1,  21, 22,  18,  18, 3),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                  60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("INFORMATION SCIENCE AND ENGINEERING",                                 60, 24, 1, 1,  2,  20, 22,  18,  18, 3),
        c_row("MECHANICAL ENGINEERING",                                              30, 12, 1, 0,  1,  10, 11,   9,   9, 2),
    ]),
    college(4, "Beary's Institute of Technology, Boliar Village, Bantwal Tq, Mangalore",
        ...
        c_row("ARTIFICIAL INTELLIGENCE AND DATA SCIENCE",                            60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("CIVIL ENGINEERING",                                                   30, 12, 1, 0,  1,  10, 11,   9,   9, 1),
        c_row("COMPUTER SCIENCE AND ENGG (INTERNET OF THINGS & CYBER SECURITY INCLUDING BLOCK CHAIN TECH)", 60, 24, 1, 1,  1,  21, 22,  18,  18, 3),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                    60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                  60, 24, 2, 0,  2,  20, 22,  18,  18, 3),
        c_row("MECHANICAL ENGINEERING",                                              60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
    ]),
    college(5, "Canara Engineering College, Bantwal",
        "BANTWAL", "Dakshina Kannada", [
        c_row("ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING",                        120, 48, 2, 1,  4,  41, 45,  36,  36, 6),
        ...
        c_row("INFORMATION SCIENCE AND ENGINEERING",                                180, 72, 4, 1,  5,  62, 67,  54,  54, 9),
        c_row("MECHANICAL ENGINEERING",                                              30, 12, 1, 0,  1,  10, 11,   9,   9, 2),
    ]),
    college(6, "Ghousia Engineering College, Ramanagara",
        ...
        c_row("CIVIL ENGINEERING",                                                   30, 12, 1, 0,  1,  10, 11,   9,   9, 1),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                   180, 72, 4, 1,  5,  62, 67,  54,  54, 9),
        c_row("COMPUTER SCIENCE AND ENGINEERING (CYBER SECURITY)",                   30, 12, 1, 0,  1,  10, 11,   9,   9, 2),
        c_row("ELECTRICAL & ELECTRONICS ENGINEERING",                                30, 12, 1, 0,  1,  10, 11,   9,   9, 1),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                  60, 24, 1, 1,  1,  21, 22,  18,  18, 3),
        c_row("INFORMATION SCIENCE AND ENGINEERING",                                 60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("ROBOTICS AND ARTIFICIAL INTELLIGENCE",                                30, 12, 0, 0,  1,  11, 12,   9,   9, 2),
    ]),
    college(7, "Gurunanak Dev Engineering College, Bidar",
        "MAILOOR ROAD, BIDAR", "Bidar", [
        ...
        c_row("COMPUTER SCIENCE AND ENGG (ARTIFICIAL INTELLIGENCE AND MACHINE LEARNING)", 60, 24, 1, 0, 16,   7, 23,  18,  18, 3),
        c_row("COMPUTER SCIENCE AND ENGG (INTERNET OF THINGS & CYBER SECURITY INCLUDING BLOCK CHAIN TECH)", 60, 24, 1, 0, 16,   7, 23,  18,  18, 3),
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                   180, 72, 4, 1, 47,  20, 67,  54,  54, 9),
        c_row("COMPUTER SCIENCE AND ENGINEERING (DATA SCIENCE)",                     60, 24, 2, 0, 16,   6, 22,  18,  18, 3),
        c_row("ELECTRICAL & ELECTRONICS ENGINEERING",                                60, 24, 1, 0, 16,   7, 23,  18,  18, 3),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                 120, 48, 3, 1, 31,  13, 44,  36,  36, 6),
    ...
    college(8, "H.K.B.K. College of Engineering, Bangalore",
        ...
        c_row("COMPUTER SCIENCE AND ENGINEERING",                                   360, 144, 7, 1, 11, 125, 136, 108, 108, 18),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                 180, 72, 4, 1,  5,  62, 67,  54,  54, 9),
    ...
    college(10, "M V J College of Engineering, Bangalore (AUTONOMOUS)",
        ...
        c_row("ELECTRICAL & ELECTRONICS ENGINEERING",                                30, 12, 1, 0,  1,  10, 11,   9,   9, 1),
        c_row("ELECTRONICS ENGINEERING(VLSI DESIGN & TECHNOLOGY)",                  60, 24, 1, 0,  2,  21, 23,  18,  18, 3),
        c_row("ELECTRONICS AND COMMUNICATION (ADVANCED COMMUNICATION TECHNOLOGY)",   60, 24, 1, 1,  2,  20, 22,  18,  18, 3),
        c_row("ELECTRONICS AND COMMUNICATION ENGG",                                 180, 72, 4, 1,  5,  62, 67,  54,  54, 9),
