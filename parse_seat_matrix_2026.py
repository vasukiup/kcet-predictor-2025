                ...
                if not pending_colleges and page_num == 91:
                    ...
                    if matched:
                        new_col = {
                            ...
                            "courses": [],
                            "established_year": matched.get("established_year") or matched.get("established"),
                            "established": matched.get("established_year") or matched.get("established"),
                            "nirf_ranking": matched.get("nirf_ranking") or matched.get("nirf_rank"),
                            "nirf_rank": matched.get("nirf_ranking") or matched.get("nirf_rank"),
                            "affiliation": matched.get("affiliation"),
                            "naac_grade": matched.get("naac_grade"),
                            "nba_accredited": matched.get("nba_accredited"),
                            "placement_stats": matched.get("placement_stats") or matched.get("placements") or {},
                            "placements": matched.get("placement_stats") or matched.get("placements") or {},
